...
export default function Feed() {
    ...
    return (
        <>
            <div className="feed">
                {
                    map(getPublicationsFolloweds, (publication, index) => (
                        <div key={index} className="feed__box">
                            ...
                            <div className="feed__box-photo" style={{ backgroundImage: `url('${publication.file}')` }} onClick={ () => openPublication(publication)}/>
            ...
            {
                showModal && (
                    <ModalPublication showModal={ showModal } setShowModal={ setShowModal } publication={ publicationSelect } />
                )
            }
        </>
    )
